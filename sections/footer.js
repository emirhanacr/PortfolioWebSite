...
<footer id="contact" class="relative bg-base border-t border-white/10 px-5 sm:px-8 md:px-16 py-24 sm:py-32">
  <div class="mx-auto max-w-5xl flex flex-col items-start gap-8 sm:gap-10">
    ...
    <div class="flex flex-wrap items-center gap-3 pt-2">
      ...
      <a href="/todo" class="border border-white/15 px-4 py-2 font-mono text-[11px] tracking-[0.2em] uppercase text-muted transition-colors duration-300 hover:text-ink hover:border-accent focus-ring">Ayrıştırıcı</a>
    </div>
