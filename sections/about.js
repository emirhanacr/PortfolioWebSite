document.getElementById('about-root').outerHTML = `
<!-- ============ ABOUT ME & TECH STACK ============ -->
<section id="about" class="relative bg-base border-t border-white/10 px-5 sm:px-8 py-20 sm:py-28 md:py-32">
  <div class="mx-auto max-w-7xl grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-16 items-start">
    ...
    <!-- Yetenek Matrisi -->
    <div>
      <span class="font-mono text-[10px] sm:text-[11px] tracking-[0.3em] text-accent uppercase">Yetenek Matrisi</span>
      <div class="mt-4 flex flex-wrap gap-2">
        <span class="rounded-full border border-white/15 px-4 py-1.5 font-mono text-[11px] tracking-[0.15em] uppercase text-muted transition-colors duration-300 hover:text-ink hover:border-accent">Photoshop</span>
